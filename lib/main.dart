...
import 'package:space_farm/presentation/pages/google_maps_page/google_maps_page.dart';
    ...
    return Scaffold(
        ...
        body: FutureBuilder<NasaPowerResponse>(
          ...
          builder: (context, snapshot) {
            ...
            final properties = data?.data.map((key, value) => MapEntry(
                key,
                ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        subtitle:
                            Text(value.values.elementAt(index).toString()),
                      );
                    })));
            ...
            return ListView(
              children: [
                ...
                Text(data
                        ...
                        ?.longname ??
                    ""),
                properties?[NASAPowerParameters.TEMPERATURE_AT_2_METERS] ??
                    Container()
              ],
            );
          },
