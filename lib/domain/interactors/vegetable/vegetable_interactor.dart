...
abstract class VegetableInteractor{
  ...
  Future<Map<String, dynamic>> getBestMonths(Location location, VegetableEnvironment environment);
}
...
class VegetableInteractorImplementation implements VegetableInteractor{
  ...
  VegetableInteractorImplementation({required NASAPowerRepository nasaPowerRespository})
  ...
  @override
  Future<Map<String, dynamic>> getBestMonths(Location location, VegetableEnvironment environment) async{
