                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: PlantPopUp(
                      ...
                      onChange: (selected){
                        context.read<HomeBloc>().changeVegetable(selected);
                      },
                    )
                  ),
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton.extended(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>VegetableScreen(position:state.selectedLocation!, vegetable:state.selectedVegetable!)));
                    }, label: Text("Evaluate", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),), backgroundColor: Colors.black,)
                  )
                  :Container()
                ],
              );
